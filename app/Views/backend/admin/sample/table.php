<table id="buttons-datatables1" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
    <thead>
        <tr>
            <th data-ordering="false">Event Date</th>
            <th data-ordering="false">Event Image</th>
            <th data-ordering="false">Event Title</th>
    ...
    <tbody>
        ...
        <?php foreach($data_list as $key=> $value) { ?>
            <tr>
                ...
                <td>
                    <img class="img-thumbnail" src="<?=image_check($value->image)?>" style="width: auto;height: 45px;">                    
                </td>
                <td><?=$value->name?></td>                
