                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <label class="form-label">Image  <small>If you want to covert .webp file <a href="https://cloudconvert.com/jpg-to-webp" target="_blank">Click to open link</a></small></label>
                                    <div class="col-lg-12">
                                        <input class="form-control upload-single-image" type="file" name="image" data-target="image" accept="image/*" <?php if(empty($row)) echo 'required'; ?>>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Image Alt <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="alt" placeholder="" value="<?=@$row->alt?>">
                                </div>
