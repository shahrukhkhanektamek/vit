                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            Your account has been created on the e-Health Care Admin HTML Theme by Propeller Pro. Below are your system generated credentials, <br><strong>Please change the password immediately after login</strong>.</p>
                                        <span
