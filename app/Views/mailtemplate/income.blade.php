                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:left;">      
                            ...
                            <img style="width: 100%;" src="{{url('/')}}/public/income-mail-new.jpg" title="logo" alt="logo">
                        </td>
                    </tr>
                    ...
                    <h2 style="text-align: center;">Great news! <br>You've Just Earned a income of <br>{{Helpers::price_formate($details['body']['amount'])}}</h2>
                         

                    <h2 style="text-align: left;margin: 0;padding: 0;font-size: 15px;">Sponsor ID:- {{sort_name.$details['body']['sponser_id']}}</h2>
                    <h2 style="text-align: left;margin: 5px 0 0 0;padding: 0;font-size: 15px;">Sponsor Name:- {{$details['body']['sponser_name']}}</h2>

                    <h2 style="text-align: left;margin: 5px 0 0 0;padding: 0;font-size: 15px;">Customer Name:- {{$details['body']['customer_name']}}</h2>
