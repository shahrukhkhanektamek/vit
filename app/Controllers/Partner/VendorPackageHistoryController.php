...
class VendorPackageHistoryController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'vendor.package-history.', 
        'title'=>'Package History', 
        'table_name'=>'vendor_package',
        'page_title'=>'Package History',
        "folder_name"=>'backend/vendor/package-history',
        "upload_path"=>'upload/',
        "page_name"=>'package-history-single.php',
       );
