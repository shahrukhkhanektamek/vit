...
class AdminBodyTypeController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'body-type.', 
        'title'=>'Body Type', 
        'table_name'=>'product_body_type',
        'page_title'=>'Body Type',
        "folder_name"=>'backend/admin/product/body-type',
        "upload_path"=>'upload/',
        "page_name"=>'body-type.php',
       );
