...
class AdminTopSpeedController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'top-speed.', 
        'title'=>'Top Speed', 
        'table_name'=>'product_top_speed',
        'page_title'=>'Top Speed',
        "folder_name"=>'backend/admin/product/top-speed',
        "upload_path"=>'upload/',
        "page_name"=>'top-speed.php',
       );
