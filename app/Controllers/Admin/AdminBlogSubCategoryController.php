...
class AdminBlogSubCategoryController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'blog-sub-category.', 
        'title'=>'Blog Sub Category', 
        'table_name'=>'blog_sub_category',
        'page_title'=>'Blog Sub Category',
        "folder_name"=>'backend/admin/blog-sub-category',
        "upload_path"=>'upload/',
        "page_name"=>'blog.php',
       );
