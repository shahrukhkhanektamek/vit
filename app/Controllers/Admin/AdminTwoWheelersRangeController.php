...
class AdminTwoWheelersRangeController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'two-wheelers-range.', 
        'title'=>'Two Wheelers Range', 
        'table_name'=>'product_two_wheelers_range',
        'page_title'=>'Two Wheelers Range',
        "folder_name"=>'backend/admin/product/two-wheelers-range',
        "upload_path"=>'upload/',
        "page_name"=>'two-wheelers-range.php',
       );
