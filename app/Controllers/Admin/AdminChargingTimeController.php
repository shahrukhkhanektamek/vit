...
class AdminChargingTimeController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'charging-time.', 
        'title'=>'Charging Time', 
        'table_name'=>'product_charging_time',
        'page_title'=>'Charging Time',
        "folder_name"=>'backend/admin/product/charging-time',
        "upload_path"=>'upload/',
        "page_name"=>'charging-time.php',
       );
