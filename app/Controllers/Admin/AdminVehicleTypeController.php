...
class AdminVehicleTypeController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'vehicle-type.', 
        'title'=>'Vehicle Type', 
        'table_name'=>'product_vehicle_type',
        'page_title'=>'Vehicle Type',
        "folder_name"=>'backend/admin/product/vehicle-type',
        "upload_path"=>'upload/',
        "page_name"=>'vehicle-type.php',
       );
