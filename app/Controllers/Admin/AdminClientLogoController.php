...
class AdminClientLogoController extends BaseController
{
     protected $arr_values = array(
        'routename'=>'client-logo.', 
        'title'=>'Post Brand', 
        'table_name'=>'client_logo',
        'page_title'=>'Post Brand',
        "folder_name"=>'backend/admin/client-logo',
        "upload_path"=>'upload/',
        "page_name"=>'client-logo.php',
       );
